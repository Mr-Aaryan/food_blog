...
<footer class=" bg-white border-t">
    <div class="max-w-5xl px-6 py-8 mx-auto">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex -mx-2">
                <a href="https://instagram.com" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-500 " aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                </a>
                <a href="https://facebook.com" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-500 " aria-label="Facebook">
                ...
                <a href="https://youtube.com" class="mx-2 text-gray-600 transition-colors duration-300  hover:text-yellow-500 " aria-label="Github">
