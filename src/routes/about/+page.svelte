...
<main class="max-w-5xl mx-auto px-5 py-10">
    ...
    <div class="py-5">
        <h1 class="text-yellow-500 font-bold text-3xl">Welcome to [COMPANY NAME]!</h1>
        <div class="prose">
                <h2>Introduction</h2>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam minima velit, dignissimos quasi officia odit officiis porro. Quod maiores, beatae dolorum illo laboriosam voluptatum enim debitis tempore ipsam illum explicabo!It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                <h2>Photography and Styling</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam minima velit, dignissimos quasi officia odit officiis porro. Quod maiores, beatae dolorum illo laboriosam voluptatum enim debitis tempore ipsam illum explicabo!It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                <h2>Community Engagement</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam minima velit, dignissimos quasi officia odit officiis porro. Quod maiores, beatae dolorum illo laboriosam voluptatum enim debitis tempore ipsam illum explicabo!It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
                <h2>Contact us</h2>
                <p>Got a question or just want to say hello? Feel free to reach out to us at <span class="text-blue-700">[contact@email.com]</span>. We'd love to hear from you!</p>
